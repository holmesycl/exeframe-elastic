...
public abstract class ElasticFrameWork {
    ...
    private LiteJobConfiguration createLiteJobConfiguration(ElasticJobConfig elasticJobConfig) {
        ...
        JobCoreConfiguration coreConfiguration = JobCoreConfiguration.newBuilder(elasticJobConfig.getJobName(), cron, elasticJobConfig.getShardingTotalCount()).jobParameter(elasticJobConfig.getJobParameter()).build();
